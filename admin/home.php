...
<head>
    ...
    <title>Dashboard | RestoBlog Admin</title>
</head>
        ...
        <header class="bg-nav">
            <div class="flex justify-between">
                ...
                <div class="p-1 flex flex-row items-center">
                    ...
                    <a href="#" onclick="profileToggle()" class="text-white p-2 no-underline hidden md:block lg:block"><?php echo "<h1>Welcome " . $_SESSION['username'] . "</h1>"; ?></a> 
