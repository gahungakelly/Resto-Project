...
<head>
    ...
    <!-- Title -->
    <title>Rwanda - Restaurants Blog | Contact</title>

    <!-- Favicon -->
    <link rel="icon" href="img/core-img/log.png">
...
<body>
                        ...
                        <div class="breaking-news">
                            <div id="breakingNewsTicker" class="ticker">
                                <ul>
                                    ...
                                    <li><a href="#">Welcome to Rwanda Resto Guide.</a></li>
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="deliciousNav">
                        ...
                        <!-- Logo -->
                        <a class="nav-brand" href="index.html"><img src="img/core-img/log.png" alt="" style="max-width: 50%;"></a>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul>
                                    ...
                                    <li><a href="#restos">Restaurants</a></li>
                                    <li><a href="#">Cuisines</a>
                                        <ul class="dropdown">
                                            <ul class="single-mega cn-col-4">
                                                <li class="title">Catagories</li>
                                                <li><a href="index.html">Indian</a></li>
                                                <li><a href="about.html">Italian</a></li>
                                                <li><a href="blog-post.html">Chinese</a></li>
                                                <li><a href="receipe-post.html">Korean</a></li>
                                                <li><a href="contact.html">Vegetarians</a></li>
                                                <li><a href="elements.html">Halal</a></li>
                                            </ul>    
                                        </ul>
                                    </li>
    ...
    <div class="breadcumb-area bg-img bg-overlay" style="background-image: url(img/core-img/log.png);"></div>
        <div class="container h-100">
